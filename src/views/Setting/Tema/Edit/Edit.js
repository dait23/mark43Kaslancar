 ...
 //}
  ...
  getData(){
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            that.setState({
              data : results.data.Tema,
              id:results.data.Tema.id,
              name:results.data.Tema.name,
              imageUrl:results.data.Tema.imageUrl,
              imageId:results.data.Tema.imageId,
              slug:results.data.Tema.slug,
              loading:false
             });
            //...
          })
  ...
  onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation updateTema ($id: ID!, $name: String!, $imageId: String, $imageUrl: String!, $slug: String!){
              updateTema (id: $id, name: $name, imageId: $imageId, imageUrl: $imageUrl, slug: $slug){
                id
                name
                imageId
                imageUrl
           ...
           {this.state.imageUrl === '' ? null :
            ...
            <Image cloudName={Cloudinary_Name} publicId={this.state.imageId} width="100" crop="scale"/>
              ...
              <div className="card-footer">
                ...
                <Link to={'/setting/tema/all'} className="btn btn-sm btn-danger"><i className="fa fa-ban"></i>&nbsp; Cancel</Link>
              </div>
            </div>
