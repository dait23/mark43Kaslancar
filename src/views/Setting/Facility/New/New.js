...
class NewFacility extends Component {
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-header">
                <strong>Add </strong> New Facility
              </div>
  ...
  handlePost = async () => {
    ...
    await this.props.addFacility({variables: {name, imageUrl, imageId}})

   //history.push('#/slider/all');
   //history.goBack;
   window.location= MainLink + "setting/facility/all";
   //window.location.reload(true);
  }

}
const addMutation = gql`
  mutation addFacility($name: String!, $imageUrl:String, $imageId: String) {
    createFacility(name: $name, imageUrl: $imageUrl, imageId: $imageId) {
      id
      name
      slug
      imageUrl
...
const PageWithMutation = graphql(addMutation, { name: 'addFacility' })(NewFacility)
