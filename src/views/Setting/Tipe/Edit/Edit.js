...
class EditTipe extends Component {
 ...
 //}
  ...
  getData(){
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            that.setState({
              data : results.data.Tipe,
              id:results.data.Tipe.id,
              name:results.data.Tipe.name,
              imageUrl:results.data.Tipe.imageUrl,
              imageId:results.data.Tipe.imageId,
              slug:results.data.Tipe.slug,
              loading:false
             });
            //...
          })
  ...
  onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation updateTipe ($id: ID!, $name: String!, $imageId: String, $imageUrl: String!, $slug: String!){
              updateTipe (id: $id, name: $name, imageId: $imageId, imageUrl: $imageUrl, slug: $slug){
                id
                name
                imageId
                imageUrl
           ...
           {this.state.imageUrl === '' ? null :
            ...
            <Image cloudName={Cloudinary_Name} publicId={this.state.imageId} width="100" crop="scale"/>
              ...
              <div className="card-footer">
                ...
                <Link to={'/setting/tipe/all'} className="btn btn-sm btn-danger"><i className="fa fa-ban"></i>&nbsp; Cancel</Link>
              </div>
            </div>
