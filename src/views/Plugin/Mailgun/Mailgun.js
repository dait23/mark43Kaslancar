  ...
  handleChange(value) {
   ...
   getData(){
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            that.setState({
              data : results.data.Mailgun,
              id:results.data.Mailgun.id,
              apiKeys:results.data.Mailgun.apiKeys,
              secretKeys:results.data.Mailgun.secretKeys,
              slug:results.data.Mailgun.slug,
              loading:false
             });
            //...
          })
   ...
   onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation updateMailgun ($id: ID!, $apiKeys: String!,$slug: String!, $secretKeys: String!){
              updateMailgun (id: $id , apiKeys: $apiKeys, slug: $slug, secretKeys: $secretKeys){
                id
                apiKeys
                secretKeys
                slug               
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            //window.location= MainLink + "plugin/mailgun";
              ...
              <div className="card-block">
                <form className="form-horizontal">
                  ...
                  <div className="form-group row">
                    <label className="col-md-3 form-control-label" htmlFor="text-input">Mailgun Api Keys</label>
                  ...
                  <div className="form-group row">
                    <label className="col-md-3 form-control-label" htmlFor="text-input">Mailgun Keys</label>
                    <div className="col-md-9">
