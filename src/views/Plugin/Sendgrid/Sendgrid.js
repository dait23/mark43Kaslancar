  ...
  handleChange(value) {
   ...
   getData(){
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            that.setState({
              data : results.data.Sendgrid,
              id:results.data.Sendgrid.id,
              apiKeys:results.data.Sendgrid.apiKeys,
              secretKeys:results.data.Sendgrid.secretKeys,
              slug:results.data.Sendgrid.slug,
              loading:false
             });
            //...
          })
   ...
   onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation updateSendgrid ($id: ID!, $apiKeys: String!,$slug: String!, $secretKeys: String!){
              updateSendgrid (id: $id , apiKeys: $apiKeys, slug: $slug, secretKeys: $secretKeys){
                id
                apiKeys
                secretKeys
                slug               
              ...
              <div className="card-block">
                <form className="form-horizontal">
                  ...
                  <div className="form-group row">
                    <label className="col-md-3 form-control-label" htmlFor="text-input">Sendgrid Api Keys</label>
                  ...
                  <div className="form-group row">
                    <label className="col-md-3 form-control-label" htmlFor="text-input">Sendgrid Keys</label>
                    <div className="col-md-9">
