  ...
  handleChange(value) {
   ...
   getData(){
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            query Foursquare($slug: String!) {
              Foursquare(slug: $slug){
              id
              apiKeys
              secretKeys
              slug
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            that.setState({
              data : results.data.Foursquare,
              id:results.data.Foursquare.id,
              apiKeys:results.data.Foursquare.apiKeys,
              secretKeys:results.data.Foursquare.secretKeys,
              slug:results.data.Foursquare.slug,
              loading:false
             });
            //...
          })
   ...
   onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation updateFoursquare ($id: ID!, $apiKeys: String!,$slug: String!, $secretKeys: String!){
              updateFoursquare (id: $id , apiKeys: $apiKeys, slug: $slug, secretKeys: $secretKeys){
                id
                apiKeys
                secretKeys
                slug               
              ...
              <div className="card-block">
                <form className="form-horizontal">
                  ...
                  <div className="form-group row">
                    <label className="col-md-3 form-control-label" htmlFor="text-input">Foursquare Api Keys</label>
                  ...
                  <div className="form-group row">
                    <label className="col-md-3 form-control-label" htmlFor="text-input">Foursquare Secret Keys</label>
                    <div className="col-md-9">
