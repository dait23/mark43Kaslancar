...
class SuspendCustomer extends React.Component {
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <i className="fa fa-files-o"></i> Suspend Member : {this.props.data._allUsersMeta.count}
               </div>
...
const ListPageWithData = graphql(FeedQuery)(SuspendCustomer)
