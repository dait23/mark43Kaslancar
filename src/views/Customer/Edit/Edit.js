     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            that.setState({
              ...
              firstName:results.data.User.customer.firstName,
              lastName:results.data.User.customer.lastName,
              imageId:results.data.User.customer.imageId,
              imageUrl:results.data.User.customer.imageUrl,
              profileId:results.data.User.customer.id,
              loading:false
             });
            //...
          })
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation($id: ID!, $firstName: String, $lastName: String, $status: Int, $profileId: ID!, $imageId: String, $imageUrl: String){
              ...
              updateCustomer( id: $profileId, imageId: $imageId, imageUrl: $imageUrl, firstName: $firstName, lastName: $lastName){
                id
                imageId
                imageUrl
              }
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            //that.getData();
            window.location= MainLink + "customer/all";
